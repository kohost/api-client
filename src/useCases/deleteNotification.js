...
export class DeleteNotificationCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} DeleteNotificationCommandConfig
   ...
   *
   * @param {DeleteNotificationCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {DeleteNotificationCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DeleteNotificationCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DeleteNotificationCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "delete" , data: DeleteNotificationCommandConfig["data"] , params: DeleteNotificationCommandConfig["query"], headers: DeleteNotificationCommandConfig["headers"] }}
     * @public
     */
    this.config = {
