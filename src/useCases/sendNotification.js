...
export class SendNotificationCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} SendNotificationCommandConfig
   ...
   *
   * @param {SendNotificationCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = SendNotificationCommand.params;
    ...
    let url = SendNotificationCommand.url;
     ...
     * @type {SendNotificationCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {SendNotificationCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {SendNotificationCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: SendNotificationCommandConfig["data"] , params: SendNotificationCommandConfig["query"], headers: SendNotificationCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: SendNotificationCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
