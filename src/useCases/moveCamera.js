...
export class MoveCameraCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveCameraCommandConfig
   ...
   *
   * @param {MoveCameraCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveCameraCommand.params;
     ...
     * @type {MoveCameraCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveCameraCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveCameraCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveCameraCommandConfig["data"] , params: MoveCameraCommandConfig["query"], headers: MoveCameraCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveCameraCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/cameras/:id/move";
