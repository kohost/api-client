...
export class MoveDimmerCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveDimmerCommandConfig
   ...
   *
   * @param {MoveDimmerCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveDimmerCommand.params;
     ...
     * @type {MoveDimmerCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveDimmerCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveDimmerCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveDimmerCommandConfig["data"] , params: MoveDimmerCommandConfig["query"], headers: MoveDimmerCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveDimmerCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/dimmers/:id/move";
