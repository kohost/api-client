...
export class ListSystemsCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} ListSystemsCommandConfig
   ...
   *
   * @param {ListSystemsCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = ListSystemsCommand.params;
    ...
    let url = ListSystemsCommand.url;
     ...
     * @type {ListSystemsCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {ListSystemsCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {ListSystemsCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: ListSystemsCommandConfig["data"] , params: ListSystemsCommandConfig["query"], headers: ListSystemsCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: ListSystemsCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
