...
export class DescribeCameraConfigCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} DescribeCameraConfigCommandConfig
   ...
   *
   * @param {DescribeCameraConfigCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = DescribeCameraConfigCommand.params;
    ...
    let url = DescribeCameraConfigCommand.url;
     ...
     * @type {DescribeCameraConfigCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DescribeCameraConfigCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DescribeCameraConfigCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: DescribeCameraConfigCommandConfig["data"] , params: DescribeCameraConfigCommandConfig["query"], headers: DescribeCameraConfigCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: DescribeCameraConfigCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/cameras/:id/config";
