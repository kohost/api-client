...
export class ValidateAuthCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} ValidateAuthCommandConfig
   ...
   *
   * @param {ValidateAuthCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = ValidateAuthCommand.params;
    ...
    let url = ValidateAuthCommand.url;
     ...
     * @type {ValidateAuthCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {ValidateAuthCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {ValidateAuthCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: ValidateAuthCommandConfig["data"] , params: ValidateAuthCommandConfig["query"], headers: ValidateAuthCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: ValidateAuthCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
