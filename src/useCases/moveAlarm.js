...
export class MoveAlarmCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveAlarmCommandConfig
   ...
   *
   * @param {MoveAlarmCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveAlarmCommand.params;
     ...
     * @type {MoveAlarmCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveAlarmCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveAlarmCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveAlarmCommandConfig["data"] , params: MoveAlarmCommandConfig["query"], headers: MoveAlarmCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveAlarmCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/alarms/:id/move";
