...
export class SendSMSCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} SendSMSCommandConfig
   ...
   *
   * @param {SendSMSCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {SendSMSCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {SendSMSCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {SendSMSCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: SendSMSCommandConfig["data"] , params: SendSMSCommandConfig["query"], headers: SendSMSCommandConfig["headers"] }}
     * @public
     */
    this.config = {
