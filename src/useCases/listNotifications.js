...
export class ListNotificationsCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} ListNotificationsCommandConfig
   ...
   *
   * @param {ListNotificationsCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {ListNotificationsCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {ListNotificationsCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {ListNotificationsCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: ListNotificationsCommandConfig["data"] , params: ListNotificationsCommandConfig["query"], headers: ListNotificationsCommandConfig["headers"] }}
     * @public
     */
    this.config = {
