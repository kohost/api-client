...
export class MoveWindowCoveringCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveWindowCoveringCommandConfig
   ...
   *
   * @param {MoveWindowCoveringCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveWindowCoveringCommand.params;
    ...
    let url = MoveWindowCoveringCommand.url;
     ...
     * @type {MoveWindowCoveringCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveWindowCoveringCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveWindowCoveringCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveWindowCoveringCommandConfig["data"] , params: MoveWindowCoveringCommandConfig["query"], headers: MoveWindowCoveringCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveWindowCoveringCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/windowCoverings/:id/move";
