...
export class CreateNotificationCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} CreateNotificationCommandConfig
   ...
   *
   * @param {CreateNotificationCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {CreateNotificationCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {CreateNotificationCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {CreateNotificationCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: CreateNotificationCommandConfig["data"] , params: CreateNotificationCommandConfig["query"], headers: CreateNotificationCommandConfig["headers"] }}
     * @public
     */
    this.config = {
