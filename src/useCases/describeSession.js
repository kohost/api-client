...
export class DescribeSessionCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} DescribeSessionCommandConfig
   ...
   *
   * @param {DescribeSessionCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = DescribeSessionCommand.params;
    ...
    let url = DescribeSessionCommand.url;
     ...
     * @type {DescribeSessionCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DescribeSessionCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DescribeSessionCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: DescribeSessionCommandConfig["data"] , params: DescribeSessionCommandConfig["query"], headers: DescribeSessionCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: DescribeSessionCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
