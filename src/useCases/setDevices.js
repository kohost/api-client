...
export class SetDevicesCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} SetDevicesCommandConfig
   ...
   *
   * @param {SetDevicesCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = SetDevicesCommand.params;
     ...
     * @type {SetDevicesCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {SetDevicesCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {SetDevicesCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: SetDevicesCommandConfig["data"] , params: SetDevicesCommandConfig["query"], headers: SetDevicesCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: SetDevicesCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
