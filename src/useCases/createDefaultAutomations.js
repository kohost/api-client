...
export class CreateDefaultAutomationsCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} CreateDefaultAutomationsCommandConfig
   ...
   *
   * @param {CreateDefaultAutomationsCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = CreateDefaultAutomationsCommand.params;
    ...
    let url = CreateDefaultAutomationsCommand.url;
     ...
     * @type {CreateDefaultAutomationsCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {CreateDefaultAutomationsCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {CreateDefaultAutomationsCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: CreateDefaultAutomationsCommandConfig["data"] , params: CreateDefaultAutomationsCommandConfig["query"], headers: CreateDefaultAutomationsCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: CreateDefaultAutomationsCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/automations/default";
