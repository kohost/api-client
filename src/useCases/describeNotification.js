...
export class DescribeNotificationCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} DescribeNotificationCommandConfig
   ...
   *
   * @param {DescribeNotificationCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {DescribeNotificationCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DescribeNotificationCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DescribeNotificationCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: DescribeNotificationCommandConfig["data"] , params: DescribeNotificationCommandConfig["query"], headers: DescribeNotificationCommandConfig["headers"] }}
     * @public
     */
    this.config = {
