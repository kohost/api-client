...
export class UpdateSystemCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} UpdateSystemCommandConfig
   ...
   *
   * @param {UpdateSystemCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = UpdateSystemCommand.params;
    ...
    let url = UpdateSystemCommand.url;
     ...
     * @type {UpdateSystemCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {UpdateSystemCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {UpdateSystemCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "put" , data: UpdateSystemCommandConfig["data"] , params: UpdateSystemCommandConfig["query"], headers: UpdateSystemCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: UpdateSystemCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
