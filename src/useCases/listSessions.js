...
export class ListSessionsCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} ListSessionsCommandConfig
   ...
   *
   * @param {ListSessionsCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = ListSessionsCommand.params;
    ...
    let url = ListSessionsCommand.url;
     ...
     * @type {ListSessionsCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {ListSessionsCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {ListSessionsCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: ListSessionsCommandConfig["data"] , params: ListSessionsCommandConfig["query"], headers: ListSessionsCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: ListSessionsCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
