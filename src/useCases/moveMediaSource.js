...
export class MoveMediaSourceCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveMediaSourceCommandConfig
   ...
   *
   * @param {MoveMediaSourceCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveMediaSourceCommand.params;
    ...
    let url = MoveMediaSourceCommand.url;
     ...
     * @type {MoveMediaSourceCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveMediaSourceCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveMediaSourceCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveMediaSourceCommandConfig["data"] , params: MoveMediaSourceCommandConfig["query"], headers: MoveMediaSourceCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveMediaSourceCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/mediaSources/:id/move";
