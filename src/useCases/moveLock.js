...
export class MoveLockCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveLockCommandConfig
   ...
   *
   * @param {MoveLockCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveLockCommand.params;
     ...
     * @type {MoveLockCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveLockCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveLockCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveLockCommandConfig["data"] , params: MoveLockCommandConfig["query"], headers: MoveLockCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveLockCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/locks/:id/move";
