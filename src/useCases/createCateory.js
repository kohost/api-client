...
export class CreateCateoryCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} CreateCateoryCommandConfig
   ...
   *
   * @param {CreateCateoryCommandConfig} commandConfig - The options to include in the command
  ...
  constructor(commandConfig, options = {}) {
     ...
     * @type {CreateCateoryCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {CreateCateoryCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {CreateCateoryCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: CreateCateoryCommandConfig["data"] , params: CreateCateoryCommandConfig["query"], headers: CreateCateoryCommandConfig["headers"] }}
     * @public
     */
    this.config = {
