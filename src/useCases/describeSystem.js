...
export class DescribeSystemCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} DescribeSystemCommandConfig
   ...
   *
   * @param {DescribeSystemCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = DescribeSystemCommand.params;
    ...
    let url = DescribeSystemCommand.url;
     ...
     * @type {DescribeSystemCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DescribeSystemCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DescribeSystemCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "get" , data: DescribeSystemCommandConfig["data"] , params: DescribeSystemCommandConfig["query"], headers: DescribeSystemCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: DescribeSystemCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
