...
export class CreateSessionCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} CreateSessionCommandConfig
   ...
   *
   * @param {CreateSessionCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = CreateSessionCommand.params;
    ...
    let url = CreateSessionCommand.url;
     ...
     * @type {CreateSessionCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {CreateSessionCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {CreateSessionCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: CreateSessionCommandConfig["data"] , params: CreateSessionCommandConfig["query"], headers: CreateSessionCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: CreateSessionCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
