...
export class MoveCourtesyCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveCourtesyCommandConfig
   ...
   *
   * @param {MoveCourtesyCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveCourtesyCommand.params;
    ...
    let url = MoveCourtesyCommand.url;
     ...
     * @type {MoveCourtesyCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveCourtesyCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveCourtesyCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveCourtesyCommandConfig["data"] , params: MoveCourtesyCommandConfig["query"], headers: MoveCourtesyCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveCourtesyCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/courtesy/:id/move";
