...
export class MoveThermostatCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveThermostatCommandConfig
   ...
   *
   * @param {MoveThermostatCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveThermostatCommand.params;
    ...
    let url = MoveThermostatCommand.url;
     ...
     * @type {MoveThermostatCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveThermostatCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveThermostatCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveThermostatCommandConfig["data"] , params: MoveThermostatCommandConfig["query"], headers: MoveThermostatCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveThermostatCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/thermostats/:id/move";
