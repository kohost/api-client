...
export class MoveSwitchCommand {
  /**
   * @description
   * @constructor
   * @typedef {object} MoveSwitchCommandConfig
   ...
   *
   * @param {MoveSwitchCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = MoveSwitchCommand.params;
     ...
     * @type {MoveSwitchCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {MoveSwitchCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {MoveSwitchCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "post" , data: MoveSwitchCommandConfig["data"] , params: MoveSwitchCommandConfig["query"], headers: MoveSwitchCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: MoveSwitchCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
   ...
   * @type {string}
   */
  static url = "/rooms/:roomId/switches/:id/move";
