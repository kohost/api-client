...
export class DeleteSessionCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} DeleteSessionCommandConfig
   ...
   *
   * @param {DeleteSessionCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = DeleteSessionCommand.params;
    ...
    let url = DeleteSessionCommand.url;
     ...
     * @type {DeleteSessionCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DeleteSessionCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DeleteSessionCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "delete" , data: DeleteSessionCommandConfig["data"] , params: DeleteSessionCommandConfig["query"], headers: DeleteSessionCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: DeleteSessionCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
