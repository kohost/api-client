...
export class DeleteSystemCommand {
   ...
   * @description
   * @constructor
   * @typedef {object} DeleteSystemCommandConfig
   ...
   *
   * @param {DeleteSystemCommandConfig} commandConfig - The options to include in the command
   * @param {Object} options - The options to include in the command
   */
  constructor(commandConfig, options = {}) {
    // get parameters from path
    const pathParams = DeleteSystemCommand.params;
    ...
    let url = DeleteSystemCommand.url;
     ...
     * @type {DeleteSystemCommandConfig["data"]}
     * @public
     */
    this.data = data;
    /**
     * The query parameters for the use case
     * @type {DeleteSystemCommandConfig["query"]}
     * @public
     */
    this.query = query;
    /**
     * The headers for the use case
     * @type {DeleteSystemCommandConfig["headers"]}
     * @public
     */
     ...
     * @type {{ url: string, method: "delete" , data: DeleteSystemCommandConfig["data"] , params: DeleteSystemCommandConfig["query"], headers: DeleteSystemCommandConfig["headers"] }}
     * @public
     */
    this.config = {
      method: DeleteSystemCommand.method,
      url: url,
      data: data,
      params: query,
      headers: headers,
